...
export function Crown({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M2 19h20v2H2v-2zm0-2l3-9 4.5 4.5L12 4l2.5 8.5L19 8l3 9H2z" />
    </svg>
  );
}
...
export function ChipIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
